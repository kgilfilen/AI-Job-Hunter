NOTE: this is an example of parsing a job description after day 4 of development. It is a C++ Developer position that matches me somewhat, but it has been ten years since I looked at C++, and it has changed signficantly in that time. This scores the job at 60, and suggests to consider it. 
